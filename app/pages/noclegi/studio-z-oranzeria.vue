...
const GALLERY: LbImage[] = [
  { src: '/miejsce/Oranzeria/oranzeria_1.jpg', alt: 'Studio z oranżerią — 1' },
  { src: '/miejsce/Oranzeria/oranzeria_2.jpg', alt: 'Studio z oranżerią — 2' },
  { src: '/miejsce/Oranzeria/oranzeria_3.jpg', alt: 'Studio z oranżerią — 3' },
  { src: '/miejsce/Oranzeria/oranzeria_4.jpg', alt: 'Studio z oranżerią — 4' },
  { src: '/miejsce/Oranzeria/oranzeria_5.jpg', alt: 'Studio z oranżerią — 5' },
  { src: '/miejsce/Oranzeria/oranzeria_6.jpg', alt: 'Studio z oranżerią — 6' },
  { src: '/miejsce/Oranzeria/oranzeria_7.jpg', alt: 'Studio z oranżerią — 7' },
  { src: '/miejsce/Oranzeria/oranzeria_8.jpg', alt: 'Studio z oranżerią — 8' },
  { src: '/miejsce/Oranzeria/oranzeria_9.jpg', alt: 'Studio z oranżerią — 9' },
  { src: '/miejsce/oranzeria.avif',            alt: 'Studio z oranżerią — widok zewnętrzny' },
  { src: '/miejsce/oranzeria-inside.avif',     alt: 'Studio z oranżerią — wnętrze' },
]
...
function openLightbox(imgIndex: number) {
  lightbox.value = { images: GALLERY, imgIndex, title: 'Studio z oranżerią' }
  ...
  <Teleport to="body">
    <Transition name="lb">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Galeria Studia z oranżerią"
        @click="closeLightbox"
      >
